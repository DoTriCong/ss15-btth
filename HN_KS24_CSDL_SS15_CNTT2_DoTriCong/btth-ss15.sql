...
-- cau 5: chan sua diem neu da qua mon
...
insert into Grades values ('SV01','MH02',-5);
insert into Grades values ('SV03','MH01',15);

update Grades set Score = 6.5 where StudentID='SV01' and SubjectID='MH01';

call sp_PayTuition();

-- update Grades set Score = 9 where StudentID='SV03' and SubjectID='MH02';
